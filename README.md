...
| 类型 | 名称 | 用途 |
| --- | --- | --- |
| Variable | `PRODUCTION_APP_URL` | 构建时写入的生产站点 HTTPS 地址 |
| Secret | `PRODUCTION_CLERK_PUBLISHABLE_KEY` | 构建时写入的 Clerk 生产环境公钥 |
| Variable | `NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY` | CI 构建和 E2E 使用的 Clerk 开发环境公钥 |
| Secret | `CLERK_SECRET_KEY` | CI E2E 使用的 Clerk 开发环境密钥 |
