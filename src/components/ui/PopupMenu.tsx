...
export function PopupMenu(props: {
  ...
  return (
    <dialog
      ...
      className={`${viewportPosition ? 'fixed z-70' : 'absolute left-1.5 z-20'} animate-modal-in m-0 max-h-[calc(100dvh-2rem)] max-w-[calc(100vw-0.75rem)] overflow-y-auto rounded-xl border border-line bg-card/95 text-ink shadow-overlay backdrop-blur ${props.surfaceClassName ?? 'w-56 p-1'} ${anchorPositionClassName}`}
