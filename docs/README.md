...
| 修改 Excalidraw 白板文档或 Team 白板协作 | [`features/documents.md`](features/documents.md)、[`architecture/rendering-and-data-flow.md`](architecture/rendering-and-data-flow.md) 和 [`adr/0016-use-document-kind-and-excalidraw-scene-protocol.md`](adr/0016-use-document-kind-and-excalidraw-scene-protocol.md) |
